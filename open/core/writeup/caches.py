...
def get_cache_key_for_gpt2_parameter(prompt, batch_size, length, temperature, top_k):
    app = "writeup"
    ...
    cache_key = f"{app}_{prompt_hash}_{batch_size}_{length}_{temperature}_{top_k}"
    return cache_key
